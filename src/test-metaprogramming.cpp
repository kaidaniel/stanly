...
struct one{int i;};
struct two{int i, j;};
struct three{int i, j, k;};
struct four{int i, j, k, l;};
...
static_assert(std::is_same_v<decltype(struct_to_tpl(two{1, 2})), std::tuple<int, int>>);
static_assert(std::is_same_v<decltype(struct_to_tpl(three{1, 2, 3})), std::tuple<int, int, int>>);
static_assert(std::is_same_v<decltype(struct_to_tpl(four{1, 2, 3, 4})), std::tuple<int, int, int, int>>);
