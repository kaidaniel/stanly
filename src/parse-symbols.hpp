...
void parse_sym_binary_operator(program& p, handle fld_left, handle fld_operator, handle fld_right);
void parse_sym_block(
    program& p, std::optional<handle> child__compound_statement,
    std::optional<handle> child__simple_statement);
void parse_sym_boolean_operator(program& p, handle fld_left, handle fld_operator, handle fld_right);
...
void parse_sym_exec_statement(program& p, std::optional<handle> child_expression, handle fld_code);
...
void parse_sym_relative_import(
    program& p, std::optional<handle> child_dotted_name, std::optional<handle> child_import_prefix);
...
void parse_sym_with_statement(program& p, std::optional<handle> child_with_clause, handle fld_body);
